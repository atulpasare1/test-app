...
Route::middleware(['role:admin'])->group(function () {
    ...
    Route::get('/question/import', [App\Http\Controllers\Admin\QuestionController::class, 'importquestion'])->name('question.import');
     Route::get('/question/{que_id}/edit', [App\Http\Controllers\Admin\QuestionController::class, 'question_edit'])->name('question.edit');
     Route::get('/question/{que_id}/edit/submit', [App\Http\Controllers\Admin\QuestionController::class, 'question_edit_submit'])->name('question.edit.submit');
     Route::get('/question/{que_id}/settings', [App\Http\Controllers\Admin\QuestionController::class, 'question_settings'])->name('question.settings');
     Route::get('/question/{que_id}/questions', [App\Http\Controllers\Admin\QuestionController::class, 'question_questions'])->name('question.questions');
     Route::get('/question/{que_id}/schedules', [App\Http\Controllers\Admin\QuestionController::class, 'question_schedules'])->name('question.schedules');
