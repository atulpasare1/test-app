...
<html
  ...
  <body>
    ...
    <div class="misc-wrapper">
      ...
      <h4 class="mb-2">Internal Server Error ⚠️</h4>
      <p class="mb-6 mx-2">something went wrong</p>
      <div class="d-flex justify-content-center mt-9">
        ...
        <div class="d-flex flex-column align-items-center">
          <img
            ...
            width="190" />
          <div>
            <a href="index.html" class="btn btn-primary text-center my-10">Back to home</a>
          </div>
        </div>
      </div>
    </div>
