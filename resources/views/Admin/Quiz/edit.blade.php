...
<div class="container-xxl flex-grow-1 container-p-y">
     <div class="row g-6 mb-8 justify-content-end">
      ...
      <div class="col-sm-2 d-grid">
        <a  href="{{route('quiz.edit',['quiz_id'=>$quiz->id])}}" class="btn {{ (Request::segment(count(Request::segments())) === 'edit') ? 'btn-primary' : 'btn-label-secondary' }}
 waves-effect">
      ...
      <div class="card-body m-5">
         <form class="m-5">
            ...
            <div class="form-floating form-floating-outline mb-8">
              <input type="text" name="title" class="form-control" id="basic-default-fullname" value="{{$quiz->title}}">
